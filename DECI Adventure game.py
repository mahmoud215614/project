...
def get_user_input(prompt, valid_inputs):
    ...
    Args:
        ...
        valid_inputs (list): The list of valid input values.
...
def choice1():
    ...
    user_choice = get_user_input("Enter 1 or 2: ", ["1", "2"])
...
def main():
    ...
    while True:
        ...
        restart = get_user_input("Enter 'y' to play again or 'n' to exit: ", ["y", "n"])
        if restart.lower() != 'y':
